...
_HSG_ANH_DE_1 = [
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": "I. Listen to the conversation and choose the correct answer for each question (1pt)",
     "passage_text": None,
     "q": "(1) What does Susan have to do on Saturday morning?",
     "options": ["A. walk the dog", "B. clean the house", "C. go to the doctor"],
     "answer": "B. clean the house"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Where does Susan have to go at 12:30?",
     "options": ["A. to school", "B. to the dentist", "C. to the science museum"],
     "answer": "B. to the dentist"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) What time is Susan meeting with Julie?",
     "options": ["A. at 12:00 p.m.", "B. at 1:00 p.m.", "C. at 2:00 p.m."],
     "answer": "C. at 2:00 p.m."},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) What will Susan do after she cooks dinner?",
     "options": ["A. clean the dishes", "B. call a friend", "C. play soccer with her brother"],
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "options": ["A. Susan doesn't like watching TV", "B. Susan's mother is going to use it.", "C. The TV isn't working."],
     "answer": "C. The TV isn't working."},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "II. Listen and fill in the gaps in the table. (1 point)",
     "passage_text": "Student 1: Name: Celine Poulain Nationality: French Age: 25 Job: (1) ___ | Student 2: Name: Manuel Garcia Nationality: (2) ___ Age: 32 Job: Engineer | Student 3: Name: Eva (3) ___ Nationality: Finnish Age: (4) ___ Job: (5) ___",
     "q": "(1) Student 1 Job: (1) ___",
     "answer": "doctor"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Student 2 Nationality: (2) ___",
     "answer": "Mexican"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Student 3 Name: Eva (3) ___",
     "answer": "Lipponen"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Student 3 Age: (4) ___",
     "answer": "twenty-one / 24"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Student 3 Job: (5) ___",
     "answer": "Artist"},
    ...
    {"type": "fill", "topic": "Reading",
     ...
     "answer": "to"},
    {"type": "essay", "topic": "Writing",
     "section_start": "SECTION 5. WRITING (Essay)",
     "section_instruction": "Phần viết luận. Viết khoảng 100-120 từ.",
     "passage_text": None,
     "q": "X. Write a paragraph (about 100 - 120 words) talking about the person you like or admire most.",
     "essay_lines": 19,
     "essay_word_min": 100,
     "essay_word_max": 120,
...
_HSG_ANH_DE_2 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "I. Listen to a talk between Mrs Mai and two students about their favourite programmes. Fill each of the gaps with NO MORE THAN THREE WORDS OR A NUMBER. You will listen TWICE. (1,25 points)",
     "passage_text": "Table | Programme Name | Channel | Content | Feelings || Mi | Kids' Funs | (1) ___ | funny (2) ___ | fun and relaxing to watch || Tom | (3) ___ | Discovery | a gigantic shark | (4) ___ || Mrs Mai | Journey to Space | 9 | (5) ___ | interesting",
     "q": "(1) Mi - Channel: (1) ___",
     "answer": "17"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Mi - Content: funny (2) ___",
     "answer": "games"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Tom - Programme Name: (3) ___",
     "answer": "Shark week"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Tom - Feelings: (4) ___",
     "answer": "thrilling"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Mrs Mai - Content: (5) ___",
     "answer": "stars and planet"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "II. Listen to a teacher giving some tips to keep the air clean. Fill each of the gaps with ONE WORD. You will listen TWICE. (1,25 points)",
     "passage_text": "The teacher gives (1) ___ tips, (2) ___ tips, and (3) ___ tips. She tells students to use gas at home instead of (4) ___ wood. She also advises students to avoid (5) ___ that smoke.",
     "q": "(1) The teacher gives (1) ___ tips",
     "answer": "household"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) use gas at home instead of (4) ___ wood",
     "answer": "burning"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) advises students to avoid (5) ___ that smoke",
     "answer": "engines"},
...
_HSG_ANH_DE_3 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "I. Listen and fill in the missing words. (1.0 point)",
     "passage_text": None,
     "q": "(1) The daughter feels …………",
     "answer": "hungry"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) She doesn't like …………",
     "answer": "noodles"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) The son is thirsty and……",
     "answer": "tired"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) He would like to drink some……",
     "answer": "orange juice"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "II. Listen then choose the correct answer. (1.0 point)",
     "passage_text": None,
     "q": "(1) Where does Philip do the photography classes?",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) What time do the photography classes begin?",
     "options": ["A. 5.15 pm", "B. 7.00 pm", "C. 6.45 pm"],
     "answer": "C. 6.45 pm"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Philip's happy with the course because he's?",
     "options": ["A. learning about famous photographers", "B. using a new camera", "C. getting better at photography"],
     "answer": "C. getting better at photography"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Philip thinks it's easy to take photographs of?",
     "options": ["A. trees", "B. animals", "C. children"],
     "answer": "A. trees"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) After the course Philip will?",
     "options": ["A. buy a new camera", "B. get a job in photography", "C. make photography his hobby"],
    ...
    {"type": "essay", "topic": "Writing",
     "section_start": "SECTION 5. WRITING (Essay)",
     "section_instruction": "Phần viết luận. Viết một đoạn văn theo gợi ý.",
     "passage_text": None,
     "q": "XIII. Write a composition (about 80 words) to tell about your mother. (Viết một bài (Khoảng 80) từ kể về Mẹ của em bằng Tiếng Anh) Lưu ý: Thí sinh không được viết Tên của mình và Tên trường trong bài luận.",
     "essay_lines": 19,
     "essay_word_min": None,
     "essay_word_max": None,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_4 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "I. You will hear a woman talking about some other people. Listen and fill in the missing information in the numbered space. (2 points)",
     "passage_text": "Table: | Name | Job | Hours per week | Amount of vacation || Peter | 1. | 2. | 3. || Susan | 4. | 5. | three weeks || Jane | 6. | 7. | 8. || Phong | 9. | 48 (hours) | 10.",
     "q": "(1) Peter - Job: 1.",
     "answer": "doctor"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Peter - Hours per week: 2.",
     "answer": "70"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Peter - Amount of vacation: 3.",
     "answer": "four weeks"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(7) Jane - Hours per week: 7.",
     "answer": "35"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(8) Jane - Amount of vacation: 8.",
     "answer": "one week"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(10) Phong - Amount of vacation: 10.",
     "answer": "two weeks"},
...
_HSG_ANH_DE_5 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "I. Listen to the passage about the healthy eating pyramid and decide if these sentences are true or false. Write your T (true) or F (false) in the answer box. You will hear the recording twice. (1,25 points)",
     "passage_text": None,
     "q": "(1) You mustn't eat sweet and salty food.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Dairy products do not contain Calcium.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Beans and nuts are not important.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Dark bread and brown rice are great sources of whole grains.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Fruit and vegetables are low in calories and full of vitamins.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "II. Listen to a passage about wild animals, then fill in the gaps with the missing information (ONE word or number). Write your answers in the answer box. You will hear the recording twice. (1,25 points)",
     "passage_text": "Table: | Name | Giant Panda | Great Green Macaw | Southern Blufin Tuna || Type of animal | Mammal | ...(2)... | Fish || Size | 150-180 centimetres long | 80-90 centimetres long | Up to ...(4)... centimetres long || Weight | 81-151 kg | ...(3)... kg | Up to 910 kg || Lives | Hills and ...(1)... in China | Rainforests | ...(5)...",
     "q": "(1) Giant Panda Lives: Hills and ...(1)... in China",
     "answer": "mountains"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Great Green Macaw Type of animal: ...(2)...",
     "answer": "bird"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Great Green Macaw Weight: ...(3)... kg",
     "answer": "1"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Southern Blufin Tuna Size: Up to ...(4)... centimetres long",
     "answer": "430"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Southern Blufin Tuna Lives: ...(5)...",
     "answer": "oceans"},
...
_HSG_ANH_DE_6 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Listen to a conversation and decide if the statements are true (T) or false (F). (10 points)",
     "passage_text": None,
     "q": "(1) Sarah is a teacher.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) She usually arrives at work at nine o'clock.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Sarah always brings a sandwich from home.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) She often has work to do in the evening.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) She never goes out during the week.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen and fill in the gaps in the table. (10 points)",
     "passage_text": "Student 1: Name: Celine (0) Poulain Nationality: French Age: 25 Job: (1) ___ | Student 2: Name: Manuel Garcia Nationality: (2) ___ Age: 32 Job: Engineer | Student 3: Name: Eva (3) ___ Nationality: Finnish Age: (4) ___ Job: (5) ___",
     "q": "(1) Student 1 Job: (1) ___",
     "answer": "doctor"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "essay", "topic": "Writing",
     "section_start": "SECTION 5. WRITING (Essay)",
     "section_instruction": "Phần viết luận. Viết khoảng 80-100 từ.",
     "passage_text": None,
     "q": "XIV. Write a paragraph (about 80 – 100 words) to tell about a person you love or admire (10 points) (Viết một bài (Khoảng 80 - 100 từ) kể về một người em yêu quý hoặc ngưỡng mộ bằng Tiếng Anh) Lưu ý: Thí sinh không được viết Tên của mình và Tên trường trong bài luận.",
     "essay_lines": 16,
     "essay_word_min": 80,
     "essay_word_max": 100,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_7 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Listen and fill in the missing words. (1,0 point)",
     "passage_text": None,
     "q": "(1) The daughter feels …………",
     "answer": "hungry"},
    {"type": "fill", "topic": "Listening",
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen then choose the correct answer. (1,0 point)",
     "passage_text": None,
     "q": "(1) Where does Philip do the photography classes?",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "passage_text": None,
     "q": "(2) What time do the photography classes begin?",
     "options": ["A. 5.15 pm", "B. 6.45 pm", "C. 7.00 pm"],
     "answer": "B. 6.45 pm"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "essay", "topic": "Writing",
     "section_start": "SECTION 5. WRITING (Essay)",
     "section_instruction": "Phần viết luận. Viết khoảng 120-150 từ.",
     "passage_text": None,
     "q": "XII. Write a paragraph (from 120 to 150 words) about the seasons in Viet Nam. (2,0 points)",
     "essay_lines": 22,
     "essay_word_min": 120,
     "essay_word_max": 150,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_8 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Listen and tick the box. Then write A,B,C or D in the box below (5 points)",
     "passage_text": None,
     "q": "(1) Where does her brother work?",
     "options": ["A. (xem audio)", "B. (xem audio)", "C. (xem audio)"],
     "answer": "C. (xem audio)"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) How does he go to work?",
     "options": ["A. (xem audio)", "B. (xem audio)", "C. (xem audio)"],
     "answer": "A. (xem audio)"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) What did he do before he started this job?",
     "options": ["A. (xem audio)", "B. (xem audio)", "C. (xem audio)"],
     "answer": "C. (xem audio)"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen and write (10 points)",
     "passage_text": "New Street school library | 0. Full name: Sarah Tanner",
     "q": "(1) Age: ………",
     "answer": "8/ eight"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part III. Listen and write the answer to correct heading. What did Ben do last week? (5 points)",
     "passage_text": "0. Monday = 0. B (He went to kind of museum and saw lots of different fish). Options A: He bought a book in the village shop and sat on the sand and read it; B: He went to kind of museum and saw lots of different fish; C: He went to the beach and climbed up to the top of a big rock; D: He went for a walk in the village, ice creams; E: He went fishing in boat; F: He saw a film about a woman climber.",
     "q": "(1) Wednesday",
     "options": ["A. (xem audio)", "B. (xem audio)", "C. (xem audio)", "D. (xem audio)", "E. (xem audio)", "F. (xem audio)"],
     "answer": "C. (xem audio)"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "essay", "topic": "Writing",
     ...
     "section_instruction": "Phần viết luận. Viết khoảng 80-100 từ.",
     "passage_text": None,
     "q": "XIII. Write a paragraph (about 80 – 100 words) to tell about your close friend. (20 points) (Do not show your name, your school's name, your village's name in the paragraph).",
     "essay_lines": 16,
     "essay_word_min": 80,
     "essay_word_max": 100,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_9 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "I. Listen and write. (1.0 point)",
     "passage_text": "BIRTHDAY PARTY | Day: (1) ___ | Place: The (2) ___-café | Number of children: (3) ___ | Where they sit: Table (4) ___ | Food: Cake, (5) ___ and ice cream.",
     "q": "(1) Day: (1) ___",
     "answer": "Saturday"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Place: The (2) ___-café",
     "answer": "CARIS"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Number of children: (3) ___",
     "answer": "18/eighteen"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Where they sit: Table (4) ___",
     "answer": "outside"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Food: Cake, (5) ___ and ice cream.",
     "answer": "sandwiches"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "II. Listen then choose the correct answer (1.0 point)",
     "passage_text": None,
     "q": "(1) What is the parrot's color?",
     "options": ["A. red and green", "B. red and blue", "C. orange and blue", "D. black and white"],
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) What is its favorite food?",
     "options": ["A. apple", "B. banana", "C. orange", "D. cake"],
     "answer": "B. banana"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) What is its name?",
     "options": ["A. Skippy", "B. Poly", "C. Polly", "D. Green"],
     "answer": "C. Polly"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) What can it say?",
     "options": ["A. Good", "B. Hello", "C. Hi", "D. morning"],
     "answer": "B. Hello"},
    # ── Phonetics III (5 MC) ──
    {"type": "choice", "topic": "Phonetics",
     "section_start": "SECTION 2. PHONETICS — III. Choose the word with different underlined sound",
...
_HSG_ANH_DE_10 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Listen Anne asking her friend about going shopping centre. And choose A/ B or C. (1.0 point)",
     "passage_text": None,
     "q": "(1) At the moment the shopping centre sells?",
     "options": ["A. clothes", "B. books", "C. food"],
     "answer": "A. clothes"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) You can take a coach to the shopping centre on?",
     "options": ["A. Mondays", "B. Tuesdays", "C. Saturdays"],
     "answer": "B. Tuesdays"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Anne's coach ticket will cost?",
     "options": ["A. £ 2.50", "B. £ 5.60", "C. £ 5.80"],
     "answer": "B. £ 5.60"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) The nearest coach stop to Anne's house is?",
     "options": ["A. in the bus station", "B. in the market square", "C. outsite the museum"],
     "answer": "C. outsite the museum"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) The coach journey takes?",
     "options": ["A. 10 minutes", "B. 20 minutes", "C. 40 minutes"],
     "answer": "C. 40 minutes"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. You will hear Susanna leaving her phone for her mother. Listen and complete questions. (1.0 point)",
     "passage_text": "Message\nFrom: Susanna\nBuy: 1. ___\nName of shop: 2. ___\nIn High Street, next to: 3. ___\nSize: 4. ___\nPrice: 5. ___",
     "q": "(1) Buy:",
     "answer": "T(-)shirt"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "passage_text": None,
     "q": "(5) Price:",
     "answer": "8.99 / eight (pounds) (and) ninety-nine (p/pence)"},
    # ── Phonetics III (3 MC) ──
    {"type": "choice", "topic": "Phonetics",
     "section_start": "SECTION 2. PHONETICS — III. Choose the word with different underlined sound",
     "section_instruction": "Choose the word whose underlined part is pronounced differently.",
    ...
    {"type": "essay", "topic": "Writing",
     ...
     "section_instruction": "Phần viết luận. Viết khoảng 120-150 từ.",
     "passage_text": None,
     "q": "XII. Write a paragraph (from 120 to 150 words) about your dream house.",
     "essay_lines": 22,
     "essay_word_min": 120,
     "essay_word_max": 150,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_11 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Listen and fill in the blanks with missing word. (1.0 point)",
     "passage_text": None,
     "q": "(1) There are totally……………rooms in Nga's new house.",
     "answer": "six/ 6"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) One of the two bathrooms is …………………………………..the two bedrooms.",
     "answer": "between"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Nga's house doesn't have a……………………………………………..",
     "answer": "dining room"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Nga's family goes fishing in the……………….in front of the house on weekends.",
     "answer": "large pond"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Nga's bedroom is big but it doesn't have much ………….",
     "answer": "furniture"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen then choose the correct answer. (1.0 point)",
...
_HSG_ANH_DE_12 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Listen and choose the correct answer. (1.0 point)",
     "passage_text": None,
     "q": "(1) Which sentence is TRUE?",
     "options": ["A. Nam's thinking about getting married.", "B. Nam's thinking about getting a new TV.", "C. Nam's thinking about getting a new apartment."],
     "answer": "B. Nam's thinking about getting a new TV."},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Trang _______ watches television.",
     "options": ["A. always", "B. usually", "C. rarely"],
     "answer": "C. rarely"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) What is Nam's favorite TV program?",
     "options": ["A. Music programs.", "B. The news.", "C. The sports."],
     "answer": "A. Music programs."},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) When will they go to the show 'Who wants to be a Millionaire?'?",
     "options": ["A. On Friday night.", "B. On Saturday night.", "C. On Sunday night."],
     "answer": "B. On Saturday night."},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Why does Trang want to come back home?",
     "options": ["A. Because she wants to see the game shows.", "B. Because she wants to do her homework.", "C. Because she wants to see the final episode of her favorite show."],
     "answer": "C. Because she wants to see the final episode of her favorite show."},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen and fill in the missing words. (1.0 point)",
     "passage_text": "1. Name of film: ___\n2. For people: ___\n3. Cost: ___\n4. Video shop in: ___\n5. Opposite: ___",
     "q": "(1) Name of film:",
     "answer": "Blue Café"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "essay", "topic": "Writing",
     ...
     "section_instruction": "Phần viết luận. Viết khoảng 100-120 từ.",
     "passage_text": None,
     "q": "XI. Write a paragraph from 100-120 words to describe a person that you admire most?",
     "essay_lines": 26,
     "essay_word_min": 100,
     "essay_word_max": 120,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_13 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (only part). Listen to the passage about Ba and Lan. Then choose the correct options by circling the corresponding letter A, B, C or D. (2.0 points)",
     "passage_text": None,
     "q": "(1) Ba and Lan go to the zoo _______ a year.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) They go to the park about twice _______.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) They _______ have a picnic.",
     "options": ["A. always", "B. usually", "C. often", "D. sometimes"],
     "answer": "D. sometimes"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) They usually play _______.",
     "options": ["A. soccer", "B. volleyball", "C. basketball", "D. sports"],
     "answer": "D. sports"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) They sometimes _______ their kites.",
     "options": ["A. fly", "B. play", "C. flies", "D. plays"],
     "answer": "A. fly"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(6) They never go camping _______ they don't have a tent.",
     "options": ["A. and", "B. but", "C. because", "D. so"],
     "answer": "C. because"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(7) They always _______ to school.",
     "options": ["A. go", "B. walk", "C. cycle", "D. drive"],
     "answer": "B. walk"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(8) They are never _______ for school.",
     "options": ["A. late", "B. early", "C. busy", "D. free"],
     "answer": "A. late"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(9) They always do their _______.",
     "options": ["A. housework", "B. math", "C. aerobics", "D. homework"],
     "answer": "D. homework"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(10) Ba and Lan are _______ students.",
     "options": ["A. bad", "B. hard-working", "C. lazy", "D. good-looking"],
...
_HSG_ANH_DE_14 = [
    ...
    {"type": "essay", "topic": "Writing",
     ...
     "section_instruction": "Phần viết luận. Viết khoảng 120-150 từ.",
     "passage_text": None,
     "q": "XII. Write a paragraph (from 120 to 150 words) about your close friend.",
     "essay_lines": 22,
     "essay_word_min": 120,
     "essay_word_max": 150,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_15 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to the following radio program with Jason Anders and complete the notes. Fill each of the gaps with NO MORE THAN THREE words. You will listen TWICE.",
     "passage_text": "WHAT TO BRING ON A CAMPING TRIP\n• Some (1) ___ or end up sleeping on the cold, wet soil\n• A blanket/sleeping bag because (2) ___ at night\n• Stove with fuel, food containers, something to fetch (3) ___ if want to cook\n• (4) ___ and bottled water to save cooking time\n• (5) ___ in case someone gets hurt",
     "q": "(1) Some ___ or end up sleeping on the cold, wet soil",
     "answer": "ground cover"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) A blanket/sleeping bag because ___ at night",
     "answer": "temperature (often) drops/falls"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Stove with fuel, food containers, something to fetch ___ if want to cook",
     "answer": "water"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) ___ and bottled water to save cooking time",
     "answer": "Canned food(s)"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) ___ in case someone gets hurt",
     "answer": "(A) first-aid kit"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to Jimmy talking about traffic. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) Jimmy thinks the traffic is fantastic.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Driving in the city is a nightmare.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) There is congestion on the radio every day.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Public transport can solve the traffic problem.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) We can breathe better if we can solve the traffic problem.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
...
_HSG_ANH_DE_16 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Listen to an interview with an Olympic swimming champion – Jackson Avery. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) Jackson won in the 500-metre competition.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Jackson went running every day before the event.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Jackson didn't have a trainer.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Jackson needed to balance between training and rest.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen to the conversation between a customer and a receptionist at the gym. Answer the questions with NO MORE THAN TWO WORDS AND/OR A NUMBER. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) What sports are they talking about?",
     "answer": "yoga"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) What class level is the customer interested in?",
     "answer": "beginner('s) (class)"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) What class time did the customer choose?",
     "answer": "6:30 (p.m.)/ six-thirty (p.m.)"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) What should the customer wear?",
     "answer": "comfortable clothes"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) What does the gym provide?",
...
_HSG_ANH_DE_17 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to an interview with an Olympic swimming champion – Jackson Avery. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) Jackson won in the 500-metre competition.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to a teenager talking about his favourite TV programme. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) He doesn't have a job.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) In Big Brother people stay to gether in a flat.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) He says celebrities appear in Big Brother.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Viewers vote for the people they like.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    # ── Grammar I MC (10 MC) ──
    {"type": "choice", "topic": "Grammar",
...
_HSG_ANH_DE_18 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to Mai talking about her summer holiday. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) Mai went to Australia with her uncle.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Mai sat next to a man on the plane.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Mai went to a concert when she was in Sydney.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) The weather was cool in Sydney.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Mai liked Sydney better than Melbourne.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to the conversation between a customer and a receptionist at the gym. Answer the questions with NO MORE THAN TWO WORDS AND/OR A NUMBER. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) What sports are they talking about?",
     "answer": "yoga"},
    {"type": "fill", "topic": "Listening",
...
_HSG_ANH_DE_19 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to a girl talking about Tet holiday in Viet Nam. Fill each of the gaps with A WORD (TWICE)",
     "passage_text": "Tet holiday in Viet Nam | Duration: (1) ______ days | Being the (2) ______ holiday in Viet Nam | Should: - (3) ______ about good things - wear (4) ______ colours | Shouldn’t: (5) ______ or swear",
     "q": "(1) Duration: (1) ______ days",
     "answer": "five/5"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Being the (2) ______ holiday in Viet Nam",
     "answer": "longest"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Should: - (3) ______ about good things",
     "answer": "think"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) wear (4) ______ colours",
     "answer": "bright"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Shouldn’t: (5) ______ or swear",
     "answer": "cry"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to some students talking about Tet holiday. Match the people with the activities they do on Tet holiday. There is one extra activity. You will listen (TWICE)",
     "passage_text": "People: 1. Nam, 2. Trang, 3. Toan, 4. Hoa, 5. Minh. Activities: A. buy and arrange flowers; B. make chung cake; C. clean the house and furniture; D. go to visit grandparents; E. visit relatives in the south; F. buy sweets and cookies",
     "q": "(1) Nam",
     "options": ["A. buy and arrange flowers", "B. make chung cake", "C. clean the house and furniture", "D. go to visit grandparents", "E. visit relatives in the south", "F. buy sweets and cookies"],
     "answer": "B. make chung cake"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Trang",
     "options": ["A. buy and arrange flowers", "B. make chung cake", "C. clean the house and furniture", "D. go to visit grandparents", "E. visit relatives in the south", "F. buy sweets and cookies"],
     "answer": "A. buy and arrange flowers"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Toan",
     "options": ["A. buy and arrange flowers", "B. make chung cake", "C. clean the house and furniture", "D. go to visit grandparents", "E. visit relatives in the south", "F. buy sweets and cookies"],
     "answer": "D. go to visit grandparents"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Hoa",
     "options": ["A. buy and arrange flowers", "B. make chung cake", "C. clean the house and furniture", "D. go to visit grandparents", "E. visit relatives in the south", "F. buy sweets and cookies"],
     "answer": "F. buy sweets and cookies"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Minh",
     "options": ["A. buy and arrange flowers", "B. make chung cake", "C. clean the house and furniture", "D. go to visit grandparents", "E. visit relatives in the south", "F. buy sweets and cookies"],
     "answer": "C. clean the house and furniture"},
    # ── Grammar I MC (10 MC) ──
    {"type": "choice", "topic": "Grammar",
     "section_start": "SECTION 3. GRAMMAR — I. Choose the best answer",
     "section_instruction": "Choose the best answer A, B, C or D.",
...
_HSG_ANH_DE_20 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Mi and Nam are talking about what they will do if they become the president of the 3Rs club. Listen and fill one word in each gap to complete the table for their ideas.",
     "passage_text": "Mi’s ideas: Put a recycling bin in every (1) ______; (2) ______ energy-saving lights. Nam’s ideas: (3) ______ students to go to school by bus; Set up a gardening (4) ______.",
     "q": "(1) Put a recycling bin in every (1) ______",
     "answer": "Classroom"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) ______ energy-saving lights.",
     "answer": "Buy"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) ______ students to go to school by bus.",
     "answer": "Encourage"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Set up a gardening (4) ______.",
     "answer": "group"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen again and write True (T) or False (F).",
     "passage_text": "Statements about 3Rs talk: Mi 6A / Nam 6E; Mi will organize book fairs; students swap new books; students grow vegetables in school garden.",
     "q": "(1) Mi is from class 6A and Nam is from class 6E.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Mi thinks, she will organize a few book fairs.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) At book fairs, students can swap their new books.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Students can grow vegetables in the school garden.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    # GRAMMAR MC
    {"type": "choice", "topic": "Grammar",
    ...
    {"type": "essay", "topic": "Writing",
     ...
     "section_instruction": "Phần viết luận. Viết một đoạn văn theo gợi ý.",
     "passage_text": None,
     "q": "III. Use the following questions to write a passage about a TV program. - What TV program do you like best? - What does it talk about? - Who is MC? - Do you watch it with your family or friends?",
     "essay_lines": 19,
     "essay_word_min": None,
     "essay_word_max": None,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_21 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to the conversation between Tony and Claudia about a robot exhibition show. Fill each of the gaps with NO MORE THAN TWO WORDS. You will listen TWICE.",
     "passage_text": "Table: Robots | Size and shape | Functions. Omnibot — as small as a (2) ______ — works as a (1) ______. Nedo — as big as a human — moves (3) ______ in natural disasters. (4) ______ — as big as a doll — tells you when the door is opened, records and (5) ______ to your parents.",
     "q": "(1) Omnibot works as a (1) ______",
     "answer": "conversation partner"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Omnibot as small as a (2) ______",
     "answer": "handbag"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Nedo moves (3) ______ in natural disasters",
     "answer": "heavy objects"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) ______ — as big as a doll",
     "answer": "Bocco/BOCCO"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) records and (5) ______ to your parents",
     "answer": "sends messages"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to a teenager talking about his favourite TV programme. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": "Big Brother reality show statements.",
     "q": "(1) He doesn’t have a job.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) In Big Brother people stay together in a flat.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
...
_HSG_ANH_DE_22 = [
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen then choose the correct answer. (1,0 point)",
     "passage_text": "Multiple-choice about Philip's photography classes.",
     "q": "(1) Where does Philip do the photography classes?",
     "options": ["A. City College", "B. Music College", "C. Math College"],
     "answer": "A. City College"},
    {"type": "choice", "topic": "Listening",
    ...
    {"type": "essay", "topic": "Writing",
     ...
     "section_instruction": "Phần viết luận. Viết khoảng 120-150 từ.",
     "passage_text": None,
     "q": "XII. Write a paragraph (from 120 to 150 words) about the seasons in Viet Nam.",
     "essay_lines": 22,
     "essay_word_min": 120,
     "essay_word_max": 150,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_24 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Listen to a conversation and decide if the statements are true (T) or false (F). (10 points)",
     "passage_text": "5 statements about Sarah.",
     "q": "(1) Sarah is a teacher.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen and fill in the gaps in the table. (10 points)",
     "passage_text": "Student 1: Name Celine (0) Poulain | Nationality French | Age 25 | Job (1)____. Student 2: Name Manuel Garcia | Nationality (2)____ | Age 32 | Job Engineer. Student 3: Name Eva (3)____ | Nationality Finnish | Age (4)____ | Job (5)____.",
     "q": "(1) Student 1 Job: (1) ______",
     "answer": "doctor"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Student 2 Nationality: (2) ______",
     "answer": "Mexican"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Student 3 Name: Eva (3) ______",
     "answer": "Lipponen"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Student 3 Age: (4) ______",
     "answer": "twenty-one / 24"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Student 3 Job: (5) ______",
     "answer": "Artist"},
    # PHONETICS
    {"type": "choice", "topic": "Phonetics",
     "section_start": "SECTION 2. PHONETICS",
    ...
    {"type": "essay", "topic": "Writing",
     ...
     "section_instruction": "Phần viết luận. Viết khoảng 80-100 từ.",
     "passage_text": None,
     "q": "XIV. Write a paragraph (about 80 – 100 words) to tell about a person you love or admire. (Viết một bài (Khoảng 80 - 100 từ) kể về một người em yêu quý hoặc ngưỡng mộ bằng Tiếng Anh). Lưu ý: Thí sinh không được viết Tên của mình và Tên trường trong bài luận.",
     "essay_lines": 16,
     "essay_word_min": 80,
     "essay_word_max": 100,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_25 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I (I). Listen and choose the correct answer. (1.0 point)",
     "passage_text": "Conversation Nam & Trang về TV programmes.",
     "q": "(1) Which sentence is TRUE?",
     "options": ["A. Nam’s thinking about getting married.", "B. Nam’s thinking about getting a new TV.", "C. Nam’s thinking about getting a new apartment."],
     "answer": "B. Nam’s thinking about getting a new TV."},
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Trang _____ watches television.",
     "options": ["A. always", "B. usually", "C. rarely"],
     "answer": "C. rarely"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II (II). Listen and fill in the missing words. (1.0 point)",
     "passage_text": "Form về Film/Video shop info.",
     "q": "(1) Name of film: ______",
     "answer": "Blue Café"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) For people: ______",
     "answer": "twelve or older"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "essay", "topic": "Writing",
     ...
     "section_instruction": "Phần viết luận. Viết khoảng 100-120 từ.",
     "passage_text": None,
     "q": "XI. Write a paragraph from 100-120 words to describe a person that you admire most? Lưu ý: Thí sinh không được viết tên của mình và tên trường trong bài luận.",
     "essay_lines": 19,
     "essay_word_min": 100,
     "essay_word_max": 120,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_26 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to Mai talking about her summer holiday. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": "5 statements về chuyến đi của Mai.",
     "q": "(1) Mai went to Australia with her uncle.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
...
_HSG_ANH_DE_27 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I (I). Listen Anne asking her friend about going shopping centre. And choose A/ B or C. (1.0 point)",
     "passage_text": "5 MC về shopping centre.",
     "q": "(1) At the moment the shopping centre sells?",
     "options": ["A. clothes", "B. books", "C. food"],
     "answer": "A. clothes"},
    {"type": "choice", "topic": "Listening",
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II (II). You will hear Susanna leaving her phone for her mother. Listen and complete questions. (1.0 point)",
     "passage_text": "Message form: Buy / Name of shop / In High Street, next to / Size / Price.",
     "q": "(1) Buy: 1. ______",
     "answer": "T (-) shirt"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Name of shop: 2. ______",
     "answer": "Davey(')s(')"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) In High Street, next to: 3. ______",
     "answer": "(the) cinema"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
...
_HSG_ANH_DE_28 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (1). Listen to Lan describing her future house. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) Lan's dream house will be huge.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) There will be different machines in each room.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) There will be a swimming pool for both adults and children.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Lan loves to have flowers on balconies.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (2). Listen to Tom talking about his dream house. Tick the things in his house. There are TWO things that will NOT be in his house. You will listen TWICE.",
     "passage_text": "Items list (tick those in his house): wi-fi TV / secret entrance / diamond room / Mario posters / rainless beach / environment / computer",
     "q": "(1) wi-fi TV",
     "options": ["A. ✔ (Có)", "B. ✘ (Không có)"],
     "answer": "B. ✘ (Không có)"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
...
_HSG_ANH_DE_29 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (I). Mi and Nam are talking about what they will do if they become the president of the 3Rs club. Listen and fill one word in each gap to complete the table for their ideas.",
     "passage_text": "Mi's ideas: Put a recycling bin in every (1)___. (2)___ energy-saving lights. | Nam's ideas: (3)___ students to go to school by bus. Set up a gardening (4)___.",
     "q": "(1) Put a recycling bin in every (1) .………………………..………",
     "answer": "Classroom"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) ………………………..…… energy - saving lights.",
     "answer": "Buy"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) …………………….………..students to go to school by bus.",
     "answer": "Encourage"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Set up a gardening (4) …………………………….",
     "answer": "group"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (II). Listen again and write True (T) or False (F).",
     "passage_text": None,
     "q": "(1) Mi is from class 6A and Nam is from class 6E.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
...
_HSG_ANH_DE_30 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to a conversation then circle the correct answer A or B to complete the sentences. ( 10 points)",
     "passage_text": None,
     "q": "(1) The students are ….. a movie for their English class.",
     "options": ["A. doing", "B. watching", "C. making"],
     "answer": "C. making"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) A movie is about ………?",
     "options": ["A. a best story", "B. an old story.", "C. a project"],
     "answer": "B. an old story."},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Phong is going to be a poor …..",
     "options": ["A. worker", "B. driver", "C. farmer."],
     "answer": "C. farmer."},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Is Phong the oldest in the group?",
     "options": ["A. Yes, he is.", "B. No, he isn't.", "C. Yes, he is header"],
     "answer": "A. Yes, he is."},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) There is also a …… in the story.",
     "options": ["A. horse", "B. bear", "C. dog"],
     "answer": "B. bear"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen and tick (). (10 points)",
     "passage_text": "Picture-based questions (DOC only shows A/B/C image placeholders, no text)",
     "q": "(1) Câu 1 (nghe audio)",
     "options": ["A. (xem audio)", "B. (xem audio)", "C. (xem audio)"],
     "answer": "C. (xem audio)"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "essay", "topic": "Writing",
     ...
     "section_instruction": "Phần viết luận. Viết khoảng 80-100 từ.",
     "passage_text": None,
     "q": "XII. Write a paragraph (80 - 100 words) about what you are going to do this summer vacation. (Do not show your name, your school's name, your village's name in the paragraph).",
     "essay_lines": 12,
     "essay_word_min": 80,
     "essay_word_max": 100,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_31 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (I). Listen to the passage then answer True or False. You will listen three times.",
     "passage_text": None,
     "q": "(1) He goes jogging with his mother.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) He goes swimming in a small river .",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) He is going to stay in a big hotel.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) He is going to buy souvenirs for his friends.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (II). Listen to Phong, Vy, Mai, Duy and write which person says what.",
     "passage_text": "Speakers: Phong, Vy, Mai, Duy",
     "q": "(1) We will live more comfortably in the near future",
     "options": ["A. Duy", "B. Mai", "C. Mi", "D. Phong", "E. Vy"],
     "answer": "E. Vy"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Robots will be able to do dangerous work for us",
     "options": ["A. Duy", "B. Mai", "C. Mi", "D. Phong", "E. Vy"],
     "answer": "A. Duy"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) If robots do all of our work, we will have nothing to do",
     "options": ["A. Duy", "B. Mai", "C. Mi", "D. Phong", "E. Vy"],
     "answer": "C. Mi"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Robots will not be able to do all of our work",
     "options": ["A. Duy", "B. Mai", "C. Mi", "D. Phong", "E. Vy"],
     "answer": "D. Phong"},
    # GRAMMAR MC
    {"type": "choice", "topic": "Grammar",
...
_HSG_ANH_DE_32 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (1). Listen to an interview with an Olympic swimming champion – Jackson Avery. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) Jackson won in the 500-metre competition.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (2). Listen to the conversation between a customer and a receptionist at the gym. Answer the questions with NO MORE THAN TWO WORDS AND/OR A NUMBER. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) What sports are they talking about?",
     "answer": "yoga"},
    {"type": "fill", "topic": "Listening",
...
_HSG_ANH_DE_33 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Listen and tick the box. Then write A,B,C or D in the box below (5 points)",
     "passage_text": "Picture-based: each question has 4 picture options A/B/C/D",
     "q": "(1) Where does her brother work?",
     "options": ["A. (xem audio)", "B. (xem audio)", "C. (xem audio)"],
     "answer": "C. (xem audio)"},
    {"type": "choice", "topic": "Listening",
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen and write ( 10 points)",
     "passage_text": "New Street school library form. 0. Full name: Sarah Tanner",
     "q": "(1) Age :",
     "answer": "8/ eight"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part III. Listen and write the answer to correct heading. What did Ben do last week ? (5 points)",
     "passage_text": "Options A–F: A. He bought a book in the village shop and sat on the sand and read it / B. He went to kind of museum and saw lots of different fish. / C. He went to the beach and climbed up to the top of a big rock / D. He went for a walk in the village , ice creams / E. He went fishing in boat / F. He saw a film about a woman climber. Example: 0. Monday = B",
     "q": "(1) Wednesday",
     "options": ["A. He bought a book in the village shop and sat on the sand and read it", "B. He went to kind of museum and saw lots of different fish.", "C. He went to the beach and climbed up to the top of a big rock", "D. He went for a walk in the village , ice creams", "E. He went fishing in boat", "F. He saw a film about a woman climber. Example: 0. Monday = B"],
     "answer": "C. He went to the beach and climbed up to the top of a big rock"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Saturday",
     "options": ["A. He bought a book in the village shop and sat on the sand and read it", "B. He went to kind of museum and saw lots of different fish.", "C. He went to the beach and climbed up to the top of a big rock", "D. He went for a walk in the village , ice creams", "E. He went fishing in boat", "F. He saw a film about a woman climber. Example: 0. Monday = B"],
     "answer": "D. He went for a walk in the village , ice creams"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Tuesday",
     "options": ["A. He bought a book in the village shop and sat on the sand and read it", "B. He went to kind of museum and saw lots of different fish.", "C. He went to the beach and climbed up to the top of a big rock", "D. He went for a walk in the village , ice creams", "E. He went fishing in boat", "F. He saw a film about a woman climber. Example: 0. Monday = B"],
     "answer": "E. He went fishing in boat"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Friday",
     "options": ["A. He bought a book in the village shop and sat on the sand and read it", "B. He went to kind of museum and saw lots of different fish.", "C. He went to the beach and climbed up to the top of a big rock", "D. He went for a walk in the village , ice creams", "E. He went fishing in boat", "F. He saw a film about a woman climber. Example: 0. Monday = B"],
     "answer": "F. He saw a film about a woman climber. Example: 0. Monday = B"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Sunday",
     "options": ["A. He bought a book in the village shop and sat on the sand and read it", "B. He went to kind of museum and saw lots of different fish.", "C. He went to the beach and climbed up to the top of a big rock", "D. He went for a walk in the village , ice creams", "E. He went fishing in boat", "F. He saw a film about a woman climber. Example: 0. Monday = B"],
     "answer": "A. He bought a book in the village shop and sat on the sand and read it"},
    # PHONETICS
    {"type": "choice", "topic": "Phonetics",
     "section_start": "SECTION 2. PHONETICS",
     "section_instruction": "Choose the word whose underlined part is pronounced differently.",
    ...
    {"type": "essay", "topic": "Writing",
     ...
     "section_instruction": "Phần viết luận. Viết khoảng 80-100 từ.",
     "passage_text": None,
     "q": "XIII. Write a paragraph (about 80 – 100 words ) to tell about your close friend. (Do not show your name, your school's name, your village's name in the paragraph).",
     "essay_lines": 12,
     "essay_word_min": 80,
     "essay_word_max": 100,
     "answer": "(Bài viết tự do — tự chấm tay)"},
...
_HSG_ANH_DE_34 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (1). Listen to a talk between Mrs Mai and two students about their favourite programmes. Fill each of the gaps with NO MORE THAN THREE WORDS OR A NUMBER. You will listen TWICE.",
     "passage_text": "Table — Mi: Kids' Funs / (1)___ / funny (2)___ / fun and relaxing to watch | Tom: (3)___ / Discovery / a gigantic shark / (4)___ | Mrs Mai: Journey to Space / 9 / (5)___ / interesting",
     "q": "(1) Mi — Channel: (1)",
     "answer": "17"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Mi — Content: funny (2)",
     "answer": "games"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Tom — Programme Name: (3)",
     "answer": "Shark Week"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Mrs Mai — Content: (5)",
     "answer": "stars and planets"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (2). Listen to a teenager talking about his favourite TV programme. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) He doesn't have a job.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
...
_HSG_ANH_DE_35 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (1). Listen to the following radio program with Jason Anders and choose the best answer to complete the following sentences. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) Some ____________ or end up sleeping on the cold, wet soil.",
     "options": ["A. ground cover", "B. over", "C. under the ground", "D. Both A & B"],
     "answer": "A. ground cover"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) We need blanket/sleeping bags because temperature often __________ at night.",
     "options": ["A. drops", "B. falls", "C. raises", "D. Both & B"],
     "answer": "B. falls"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Stove with fuel, food containers, something to fetch __________ if want to cook.",
     "options": ["A. oil", "B. money", "C. wood", "D. water"],
     "answer": "D. water"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) _____________ and bottled water to save cooking time.",
     "options": ["A. Meat", "B. Rice", "C. Canned food", "D. Fruit"],
     "answer": "C. Canned food"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) ___________ in case someone gets hurt.",
     "options": ["A. first-aid kit", "B. clothes", "C. food", "D. drink"],
     "answer": "A. first-aid kit"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (2). Listen to Jimmy talking about traffic. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": None,
     "q": "(1) Jimmy thinks the traffic is fantastic.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
