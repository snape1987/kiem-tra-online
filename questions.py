...
_HSG_ANH_DE_1 = [
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": "Part 1 (I). Listen to the conversation and choose the correct answer for each question. (1pt)",
     "passage_text": None,
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (II). Listen and fill in the gaps in the table. (1 point)",
     "passage_text": "Student 1: Name: Celine Poulain | Nationality: French | Age: 25 | Job: (1)___\nStudent 2: Name: Manuel Garcia | Nationality: (2)___ | Age: 32 | Job: Engineer\nStudent 3: Name: Eva (3)___ | Nationality: Finnish | Age: (4)___ | Job: (5)___",
     "q": "(1) Celine's job",
     "answer": "doctor"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
...
_HSG_ANH_DE_2 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (I). Listen to a talk between Mrs Mai and two students about their favourite programmes. Fill each of the gaps with NO MORE THAN THREE WORDS OR A NUMBER. You will listen TWICE. (1,25 points)",
     "passage_text": "| Person | Programme Name | Channel | Content | Feelings |\nMi: Kids' Funs | (1)___ | funny (2)___ | fun and relaxing to watch\nTom: (3)___ | Discovery | a gigantic shark | (4)___\nMrs Mai: Journey to Space | 9 | (5)___ | interesting",
     "q": "(1) Mi's channel",
     "answer": "17"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Mi's content (funny ___)",
     "answer": "games"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Tom's programme name",
     "answer": "Shark Week"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Mrs Mai's content",
     "answer": "stars and planets"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (II). Listen to a teacher giving some tips to keep the air clean. Fill each of the gaps with ONE WORD. You will listen TWICE. (1,25 points)",
     ...
     "q": "(1) first category of tips",
     "answer": "household"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) second category of tips",
     "answer": "garden"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) third category of tips",
     "answer": "transportation"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) instead of ___ wood",
     "answer": "burning"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
...
_HSG_ANH_DE_3 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (I). Listen and fill in the missing words. (1.0 point)",
     "passage_text": None,
     "q": "(1) The daughter feels ___",
     "answer": "hungry"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) She wants some ___",
     "answer": "apples"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) She doesn't like ___",
     "answer": "noodles"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) The son is thirsty and ___",
     "answer": "tired"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) He would like to drink some ___",
     "answer": "orange juice"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (II). Listen then choose the correct answer. (1.0 point)",
     "passage_text": None,
...
_HSG_ANH_DE_4 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (I). You will hear a woman talking about some other people. Listen and fill in the missing information in the numbered space. (2 points)",
     "passage_text": "| Name | Job | Hours per week | Amount of vacation |\nPeter | (1) | (2) | (3)\nSusan | (4) | (5) | three weeks\nJane | (6) | (7) | (8)\nPhong | (9) | 48 (hours) | (10)",
     "q": "(1) Peter's job",
     "answer": "doctor"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Peter's hours per week",
     "answer": "70"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Peter's vacation",
     "answer": "four weeks"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
...
_HSG_ANH_DE_5 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (I). Listen to the passage about the healthy eating pyramid and decide if these sentences are true or false. Write your T (true) or F (false) in the answer box. You will hear the recording twice. (1,25 points)",
     "passage_text": None,
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (II). Listen to a passage about wild animals, then fill in the gaps with the missing information (ONE word or number). Write your answers in the answer box. You will hear the recording twice. (1,25 points)",
     "passage_text": "| Name | Giant Panda | Great Green Macaw | Southern Bluefin Tuna |\nType of animal | Mammal | (2) | Fish\nSize | 150-180 cm long | 80-90 cm long | Up to (4) cm long\nWeight | 81-151 kg | (3) kg | Up to 910 kg\nLives | Hills and (1) in China | Rainforests | (5)",
     "q": "(1) Giant Panda lives in Hills and ___ in China",
     "answer": "mountains"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Great Green Macaw - type of animal",
     "answer": "bird"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Great Green Macaw - weight (kg)",
     "answer": "1"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Southern Bluefin Tuna - size (cm long)",
     "answer": "430"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Southern Bluefin Tuna lives in",
     "answer": "oceans"},
...
_HSG_ANH_DE_6 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to a conversation and decide if the statements are true (T) or false (F). (10 points)",
     "passage_text": None,
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen and fill in the gaps in the table. (10 points)",
     "passage_text": "Student 1: Name: Celine (0) Poulain | Nationality: French | Age: 25 | Job: (1)___\nStudent 2: Name: Manuel Garcia | Nationality: (2)___ | Age: 32 | Job: Engineer\nStudent 3: Name: Eva (3)___ | Nationality: Finnish | Age: (4)___ | Job: (5)___",
     "q": "(1) Celine's job",
     "answer": "doctor"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
...
_HSG_ANH_DE_8 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen and tick the box. Then write A, B, C or D in the box below. (5 points)",
     "passage_text": None,
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen and write. (10 points) — New Street school library, Full name: Sarah Tanner",
     "passage_text": "0. Full name: Sarah Tanner",
     "q": "(1) Age",
     "answer": "8 / eight"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 3. Listen and write the answer to correct heading. What did Ben do last week? (5 points) — Match day to activity (A-F).",
     "passage_text": "Options: A. bought a book in village shop, sat on sand to read; B. went to museum, saw different fish; C. went to beach, climbed big rock; D. walk in village, ice creams; E. went fishing in boat; F. saw film about woman climber. (Monday = B given)",
     "q": "(1) Wednesday",
...
_HSG_ANH_DE_9 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1 (I). Listen and write. (1.0 point) — BIRTHDAY PARTY",
     "passage_text": "BIRTHDAY PARTY\nDay: (1)___\nPlace: The (2)___ café\nNumber of children: (3)___\nWhere they sit: Table (4)___\nFood: Cake, (5)___ and ice cream.",
     "q": "(1) Day",
     "answer": "Saturday"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Number of children",
     "answer": "18 / eighteen"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Where they sit (Table ___)",
     "answer": "outside"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Food (Cake, ___, and ice cream)",
     "answer": "sandwiches"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2 (II). Listen then choose the correct answer. (1.0 point) — about a parrot",
     "passage_text": None,
...
_HSG_ANH_DE_10 = [
    {"type": "choice", "topic": "Listening",
     ...
     "passage_text": "Anne asking her friend about going to a shopping centre",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "options": ["A. in the bus station", "B. in the market square", "C. outside the museum"],
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "passage_text": "Message from Susanna to her mother about buying a T-shirt",
     "q": "(1) Buy: ____",
     "answer": "T-shirt"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Name of shop: ____",
     "answer": "Davey's"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) In High Street, next to: ____",
     "answer": "the cinema"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "passage_text": None,
     "q": "(5) Price: ____",
     "answer": "8.99 / eight pounds ninety-nine"},
    # ── Phonetics III (3 MC) ──
    {"type": "choice", "topic": "Phonetics",
     "section_start": "SECTION 2. PHONETICS — III. Choose the word with different underlined sound",
     "section_instruction": "Choose the word whose underlined part is pronounced differently.",
...
_HSG_ANH_DE_11 = [
    {"type": "fill", "topic": "Listening",
     ...
     "passage_text": "About Nga's new house",
     "q": "(1) There are totally ____ rooms in Nga's new house.",
     "answer": "six / 6"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) One of the two bathrooms is ____ the two bedrooms.",
     "answer": "between"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Nga's house doesn't have a ____",
     "answer": "dining room"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Nga's family goes fishing in the ____ in front of the house on weekends.",
     "answer": "large pond"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Nga's bedroom is big but it doesn't have much ____",
     "answer": "furniture"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part II. Listen then choose the correct answer. (1.0 point)",
     "passage_text": "About Philip's photography classes",
     "q": "(1) Where does Philip do the photography classes?",
     "options": ["A. Music College", "B. City College", "C. Math College"],
     "answer": "B. City College"},
    {"type": "choice", "topic": "Listening",
...
_HSG_ANH_DE_12 = [
    {"type": "choice", "topic": "Listening",
     ...
     "passage_text": "Conversation between Nam and Trang about TV programmes",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Trang ____ watches television.",
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "passage_text": "Information about a film at a video shop",
     "q": "(1) Name of film: ____",
     "answer": "Blue Café"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
...
_HSG_ANH_DE_13 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part I. Listen to the passage about Ba and Lan. Then choose the correct options by circling the corresponding letter A, B, C or D. (2.0 points)",
     "passage_text": "Passage about Ba and Lan: zoo/park/sports/school",
     "q": "(1) Ba and Lan go to the zoo ____ a year.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) They go to the park about twice ____.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) They sometimes ____ their kites.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(6) They never go camping ____ they don't have a tent.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(7) They always ____ to school.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(8) They are never ____ for school.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(10) Ba and Lan are ____ students.",
...
_HSG_ANH_DE_15 = [
    {"type": "fill", "topic": "Listening",
     ...
     "q": "(1) Some ____ or end up sleeping on the cold, wet soil",
     "answer": "ground cover"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) A blanket/sleeping bag because ____ at night",
     "answer": "temperature (often) drops/falls"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Stove with fuel, food containers, something to fetch ____ if want to cook",
     "answer": "water"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) ____ and bottled water to save cooking time",
     "answer": "Canned food(s)"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) ____ in case someone gets hurt",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "passage_text": "Jimmy talking about traffic",
...
_HSG_ANH_DE_16 = [
    {"type": "choice", "topic": "Listening",
     ...
     "passage_text": "Interview with Olympic swimming champion Jackson Avery",
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "passage_text": "Conversation at a gym (customer and receptionist)",
...
_HSG_ANH_DE_17 = [
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "passage_text": "Teenager talking about his favourite TV programme (Big Brother)",
...
_HSG_ANH_DE_18 = [
    {"type": "choice", "topic": "Listening",
     ...
     "passage_text": "Mai talking about her summer holiday in Australia",
...
_HSG_ANH_DE_19 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to a girl talking about Tet holiday in Viet Nam. Fill each of the gaps with A WORD.",
     "passage_text": "Tet holiday in Viet Nam — Duration / Being the ... holiday / Should / Shouldn't",
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to some students talking about Tet holiday. Match the people with the activities they do on Tet holiday. There is one extra activity.",
     "passage_text": "Activities: A. buy and arrange flowers / B. make chung cake / C. clean the house and furniture / D. go to visit grandparents / E. visit relatives in the south / F. buy sweets and cookies",
     "q": "(1) Nam",
...
_HSG_ANH_DE_20 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Mi and Nam are talking about what they will do if they become the president of the 3Rs club. Listen and fill one word in each gap to complete the table for their ideas.",
     "passage_text": "Mi's ideas / Nam's ideas",
     "q": "(1) Mi's ideas: Put a recycling bin in every (1) ______",
     "answer": "classroom"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "fill", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Nam's ideas: (3) ______ students to go to school by bus.",
     "answer": "Encourage"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen again and write True (T) or False (F).",
     "passage_text": "Statements about Mi and Nam's conversation",
...
_HSG_ANH_DE_21 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to the conversation between Tony and Claudia about a robot exhibition show. Fill each of the gaps with NO MORE THAN TWO WORDS.",
     "passage_text": "Robots table: Omnibot / Nedo / (4) ____ with Size/shape and Functions columns",
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to a teenager talking about his favourite TV programme. Decide if the statements are true (T) or false (F).",
     "passage_text": "Big Brother reality TV show",
     "q": "(1) He doesn't have a job.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
...
_HSG_ANH_DE_22 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen and fill in the missing words.",
     "passage_text": "Dialogue about family — daughter's & son's feelings/wants",
     "q": "(1) The daughter feels ______",
     "answer": "hungry"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) She wants some ______",
     "answer": "apples"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) She doesn't like ______",
     "answer": "noodles"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) The son is thirsty and ______",
     "answer": "tired"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) He would like to drink some ______",
     "answer": "orange juice"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen then choose the correct answer.",
     "passage_text": "Philip and his photography classes",
     "q": "(1) Where does Philip do the photography classes?",
     "options": ["A. City College", "B. Music College", "C. Math College"],
     "answer": "A. City College"},
    {"type": "choice", "topic": "Listening",
...
_HSG_ANH_DE_24 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to a conversation and decide if the statements are true (T) or false (F).",
     "passage_text": "About Sarah's work and routine",
     "q": "(1) Sarah is a teacher.",
     "options": ["A. True", "B. False"],
     "answer": "A. True"},
    {"type": "choice", "topic": "Listening",
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen and fill in the gaps in the table.",
     "passage_text": "Three students: Celine Poulain (French, 25) / Manuel Garcia (?, 32, Engineer) / Eva ? (Finnish, ?, ?)",
     "q": "(1) Student 1 Celine Poulain — Job: (1) ______",
     "answer": "doctor"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Student 2 Manuel Garcia — Nationality: (2) ______",
     "answer": "Mexican"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Student 3 Eva — Surname: (3) ______",
     "answer": "Lipponen"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Student 3 Eva — Age: (4) ______",
     "answer": "twenty-one"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Student 3 Eva — Job: (5) ______",
     "answer": "Artist"},
    # PHONETICS
    {"type": "choice", "topic": "Phonetics",
     "section_start": "SECTION 2. PHONETICS",
...
_HSG_ANH_DE_25 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen and choose the correct answer.",
     "passage_text": "Conversation between Nam and Trang about TV programs",
     "q": "(1) Which sentence is TRUE?",
     "options": ["A. Nam's thinking about getting married.", "B. Nam's thinking about getting a new TV.", "C. Nam's thinking about getting a new apartment."],
     "answer": "B. Nam's thinking about getting a new TV."},
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Trang ______ watches television.",
     "options": ["A. always", "B. usually", "C. rarely"],
     "answer": "C. rarely"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen and fill in the missing words.",
     "passage_text": "Film info: Name of film / For people / Cost / Video shop in / Opposite",
...
_HSG_ANH_DE_26 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to Mai talking about her summer holiday. Decide if the statements are true (T) or false (F).",
     "passage_text": "Mai's trip to Australia (Sydney and Melbourne)",
     "q": "(1) Mai went to Australia with her uncle.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
...
_HSG_ANH_DE_27 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen Anne asking her friend about going shopping centre. And choose A, B or C.",
     "passage_text": "Shopping centre / coach details",
     "q": "(1) At the moment the shopping centre sells?",
     "options": ["A. clothes", "B. books", "C. food"],
     "answer": "A. clothes"},
    {"type": "choice", "topic": "Listening",
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. You will hear Susanna leaving her phone for her mother. Listen and complete questions.",
     "passage_text": "Phone message from Susanna — Buy / Name of shop / next to / Size / Price",
     "q": "(1) Buy: ______",
     "answer": "T-shirt"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Name of shop: ______",
     "answer": "Davey's"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) In High Street, next to: ______",
     "answer": "the cinema"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
...
_HSG_ANH_DE_28 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to Lan describing her future house. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": "Lan describes her dream/future house.",
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to Tom talking about his dream house. Tick the things in his house. There are TWO things that will NOT be in his house. You will listen TWICE.",
     "passage_text": "Tom describes his dream house features. Tick = thing is in his house.",
     "q": "(1) wi-fi TV",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
...
_HSG_ANH_DE_29 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Mi and Nam are talking about what they will do if they become the president of the 3Rs club. Listen and fill one word in each gap to complete the table for their ideas.",
     "passage_text": "Mi's ideas and Nam's ideas about the 3Rs club.",
     "q": "(1) Mi: Put a recycling bin in every (1) ____.",
     "answer": "classroom"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Mi: (2) ____ energy-saving lights.",
     "answer": "Buy"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Nam: (3) ____ students to go to school by bus.",
     "answer": "Encourage"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Nam: Set up a gardening (4) ____.",
     "answer": "group"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen again and write True (T) or False (F).",
...
_HSG_ANH_DE_30 = [
    {"type": "choice", "topic": "Listening",
     ...
     "passage_text": "A group of students discusses a movie they are making for English class.",
     "q": "(1) The students are ___ a movie for their English class.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Phong is going to be a poor ___.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) There is also a ___ in the story.",
     "options": ["A. horse", "B. bear", "C. dog"],
     "answer": "B. bear"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen and tick. (10 points) - Picture-based multiple choice (A/B/C).",
     "passage_text": "Picture-based questions; DOC contains only the answer keys (pictures not readable).",
     "q": "(1) Question 1 (picture A/B/C)",
     "options": ["A. (xem audio)", "B. (xem audio)", "C. (xem audio)"],
     "answer": "C. (xem audio)"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
...
_HSG_ANH_DE_31 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to the passage then answer True or False. You will listen three times.",
     "passage_text": "A passage about someone's holiday activities.",
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to Phong, Vy, Mai, Duy and write which person says what.",
     "passage_text": "Four speakers (Phong, Vy, Mai, Duy) give opinions about robots in the future.",
...
_HSG_ANH_DE_32 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to an interview with an Olympic swimming champion – Jackson Avery. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": "Interview with Jackson Avery, Olympic swimming champion.",
     "q": "(1) Jackson won in the 500-metre competition.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to the conversation between a customer and a receptionist at the gym. Answer the questions with NO MORE THAN TWO WORDS AND/OR A NUMBER. You will listen TWICE.",
     "passage_text": "A customer asks the gym receptionist about a yoga class.",
     "q": "(1) What sports are they talking about?",
     "answer": "yoga"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
...
_HSG_ANH_DE_33 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen and tick the box. Then write A, B, C or D in the box below. (5 points) - Questions about her brother's job.",
     "passage_text": "Speaker describes where/how/when her brother works.",
     "q": "(1) Where does her brother work?",
     "options": ["A. (xem audio)", "B. (xem audio)", "C. (xem audio)"],
     "answer": "C. (xem audio)"},
    {"type": "choice", "topic": "Listening",
    ...
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen and write (10 points) - New Street school library form for Sarah Tanner.",
     "passage_text": "Library registration form for Sarah Tanner.",
     "q": "(1) Age:",
     "answer": "8 / eight"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 3. Listen and write the answer to correct heading. What did Ben do last week? (5 points)",
     "passage_text": "Match each day to an activity (A-F). 0. Monday = B (sample).",
     "q": "(1) Wednesday",
     "options": ["A. (xem audio)", "B. (xem audio)", "C. (xem audio)", "D. (xem audio)", "E. (xem audio)", "F. (xem audio)"],
     "answer": "C. (xem audio)"},
    {"type": "choice", "topic": "Listening",
...
_HSG_ANH_DE_34 = [
    {"type": "fill", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to a talk between Mrs Mai and two students about their favourite programmes. Fill each of the gaps with NO MORE THAN THREE WORDS OR A NUMBER. You will listen TWICE.",
     "passage_text": "Mi watches Kids' Funs; Tom watches a show on Discovery; Mrs Mai watches Journey to Space on channel 9.",
     "q": "(1) Mi - Kids' Funs - Channel: (1) ____",
     "answer": "17"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) Mi - Kids' Funs - Content: funny (2) ____",
     "answer": "games"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(3) Tom - Programme Name: (3) ____ (on Discovery, about a gigantic shark)",
     "answer": "Shark Week"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(4) Tom - Feelings: (4) ____",
     "answer": "thrilling"},
    {"type": "fill", "topic": "Listening",
     "section_start": None,
     "section_instruction": None,
     "passage_text": None,
     "q": "(5) Mrs Mai - Journey to Space - Content: (5) ____",
     "answer": "stars and planets"},
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to a teenager talking about his favourite TV programme. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": "A teenager talks about Big Brother (reality TV show).",
     "q": "(1) He doesn't have a job.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
...
_HSG_ANH_DE_35 = [
    {"type": "choice", "topic": "Listening",
     "section_start": "SECTION 1. LISTENING",
     "section_instruction": "Part 1. Listen to the following radio program with Jason Anders and choose the best answer to complete the following sentences. You will listen TWICE.",
     "passage_text": "Radio program about camping/outdoor preparation tips.",
    ...
    {"type": "choice", "topic": "Listening",
     ...
     "section_instruction": None,
     "passage_text": None,
     "q": "(2) We need blanket/sleeping bags because temperature often ___ at night.",
    ...
    {"type": "choice", "topic": "Listening",
     "section_start": None,
     "section_instruction": "Part 2. Listen to Jimmy talking about traffic. Decide if the statements are true (T) or false (F). Circle T or F. You will listen TWICE.",
     "passage_text": "Jimmy talks about city traffic, congestion, and public transport.",
     "q": "(1) Jimmy thinks the traffic is fantastic.",
     "options": ["A. True", "B. False"],
     "answer": "B. False"},
    {"type": "choice", "topic": "Listening",
